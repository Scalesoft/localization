(function (global, factory) {
    ...
    var Localization = /** @class */ (function () {
        function Localization(localizationConfiguration) {
            ...
            this.mLocalizationConfiguration = localizationConfiguration === undefined || localizationConfiguration === null
                ? {
                    errorResolution: exports.LocalizationErrorResolution.Key,
        ...
        Localization.prototype.getTranslationOnError = function (text, scope) {
            switch (this.mLocalizationConfiguration.errorResolution) {
                case exports.LocalizationErrorResolution.Null:
                    return null;
                case exports.LocalizationErrorResolution.Key:
                    return {
                        name: text,
        ...
        Localization.prototype.downloadDictionary = function (scope, cultureName) {
            ...
            xmlHttpRequest.open("GET", "".concat(this.getBaseUrl(), "/Localization/Dictionary?scope=").concat(scope), false);
            xmlHttpRequest.send();
        };
        Localization.prototype.downloadDictionaryAsync = function (scope, cultureName, onSuccess, onFailed) {
            ...
            */
            ...
            if (this.mDictionaryQueue[scope] === undefined) {
                ...
                xmlHttpRequest_1.open("GET", "".concat(this.getBaseUrl(), "/Localization/Dictionary?scope=").concat(scope), true);
        ...
        Localization.prototype.downloadPluralizedDictionary = function (scope, cultureName) {
            ...
            xmlHttpRequest.open("GET", "".concat(this.getBaseUrl(), "/Localization/PluralizedDictionary?scope=").concat(scope), false);
            xmlHttpRequest.send();
        };
        Localization.prototype.downloadPluralizedDictionaryAsync = function (scope, cultureName, onSuccess, onFailed) {
            ...
            */
            ...
            if (this.mPluralizedDictionaryQueue[scope] === undefined) {
                ...
                xmlHttpRequest_2.open("GET", "".concat(this.getBaseUrl(), "/Localization/PluralizedDictionary?scope=").concat(scope), true);
        ...
        Localization.prototype.getDownloadPromise = function (dictionaryFactory, dictionaryCache, path, scope, cultureName) {
            ...
            return new Promise(function (resolve, reject) {
                var xmlHttpRequest = new XMLHttpRequest();
                xmlHttpRequest.open("GET", "".concat(_this.getBaseUrl(), "/Localization/").concat(path, "?scope=").concat(scope), true);
                xmlHttpRequest.send();
                xmlHttpRequest.onreadystatechange = function () {
                    if (xmlHttpRequest.readyState !== XMLHttpRequest.DONE) {
                        return;
        ...
        Localization.prototype.getCurrentCulture = function () {
            ...
            if (this.mCurrentCulture === undefined) {
                ...
                if (!parsedCookieValue) {
                    ...
                    xmlHttpRequest_3.open("GET", "".concat(this.getBaseUrl(), "/Localization/CurrentCulture"), false);
            ...
            return new Promise(function (resolve, reject) {
                if (_this.mCurrentCulture === undefined) {
                    ...
                    if (!parsedCookieValue) {
                        ...
                        xmlHttpRequest_4.open("GET", "".concat(_this.getBaseUrl(), "/Localization/CurrentCulture"), true);
        ...
        Localization.prototype.getParsedCultureCookie = function () {
            ...
            if (parsedCookieValue.currentCulture === undefined) {
                console.error("Unexpected value of the cookie ".concat(this.mCultureCookieName, ". Expected object with property 'currentCulture'."), parsedCookieValue);
            }
    ...
    var BaseLocalizationDictionary = /** @class */ (function () {
        ...
        BaseLocalizationDictionary.prototype.getFallbackTranslation = function (text, scope, cultureName) {
            console.log("Localized string with key=".concat(text, " was not found in dictionary=").concat(scope, " with culture=").concat(cultureName));
    ...
    exports.LocalizationErrorResolution = void 0;
    ...
    })(exports.LocalizationErrorResolution || (exports.LocalizationErrorResolution = {}));
    ...
    exports.BaseLocalizationDictionary = BaseLocalizationDictionary;
    exports.Localization = Localization;
    exports.LocalizationDictionary = LocalizationDictionary;
    exports.LocalizationDictionaryStatusSuccess = LocalizationDictionaryStatusSuccess;
    exports.LocalizationPluralizationDictionary = LocalizationPluralizationDictionary;
    exports.LocalizationResult = LocalizationResult;
