...
BEGIN TRAN
	...
	(
		...
		[Culture] int NOT NULL CONSTRAINT [FK_StaticText(Culture)_Culture(Id)] FOREIGN KEY REFERENCES [dbo].[Culture],
	    ...
	    [Name] varchar(255) CONSTRAINT [UQ_StaticText(Name)] NOT NULL,
	    [Format] smallint NOT NULL,
		[Discriminator] nvarchar(max) NOT NULL,
		[Text] nvarchar(max) NOT NULL,   
	    [ModificationTime] datetime NOT NULL DEFAULT GETDATE(),
	    [ModificationUser] varchar(255) NULL,
		CONSTRAINT [UQ_CultureHierarchy(Culture,DictionaryScope,Name)] UNIQUE([Culture], [DictionaryScope], [Name])
	)
