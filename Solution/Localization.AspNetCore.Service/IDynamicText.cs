...
namespace Localization.AspNetCore.Service
{
    public interface IDynamicText
    {
        ...
        CoreLibrary.Entity.DynamicText SaveDynamicText(CoreLibrary.Entity.DynamicText dynamicText, DefaultCultureAction actionOnSave = DefaultCultureAction.Nothing);
